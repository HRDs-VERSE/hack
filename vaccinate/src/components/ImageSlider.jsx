        ...
        <div className="relative grid place-items-center top-[18rem]">
          ...
          <div className='flex'>
            <Button radius="sm" className='m-2'>
              <Link to="find-vaccine" className="btn btn-outline-primary">Find Vaccine</Link>
            </Button>
            <Button radius='sm' className='m-2'>
              <Link to="https://selfregistration.cowin.gov.in/" className="btn btn-outline-primary">Book Slot</Link>
            </Button>
